  ...
  SELECT 
    ...
    getContactPhone(mc.cntct_id, 'Office') AS billing_contact_voice,
    getContactPhone(mc.cntct_id, 'Mobile') AS billing_contact_alternate,
    getContactPhone(mc.cntct_id, 'Fax') AS billing_contact_fax,
    ...
    getContactPhone(cc.cntct_id, 'Office') AS correspond_contact_voice,
    getContactPhone(cc.cntct_id, 'Mobile')  AS correspond_contact_alternate,
    getContactPhone(cc.cntct_id, 'Fax') AS correspond_contact_fax,
...
INSERT INTO custinfo
	...
	END,
        ...
        saveCntct(
          ...
          buildSimplePhoneJson(NEW.billing_contact_voice, NEW.billing_contact_alternate, NEW.billing_contact_fax),
        ...
        saveCntct(
          ...
          buildSimplePhoneJson(NEW.correspond_contact_voice, NEW.correspond_contact_alternate, NEW.correspond_contact_fax),
