...
SELECT 
  ...
  c1.cntct_title AS contact1_job_title,
    getContactPhone(c1.cntct_id, 'Office') AS contact1_voice,
    getContactPhone(c1.cntct_id, 'Mobile') AS contact1_alternate,
    getContactPhone(c1.cntct_id, 'Fax') AS contact1_fax,
  ...
  c2.cntct_title AS contact2_job_title,
    getContactPhone(c2.cntct_id, 'Office') AS contact2_voice,
    getContactPhone(c2.cntct_id, 'Mobile') AS contact2_alternate,
    getContactPhone(c2.cntct_id, 'Fax') AS contact2_fax,
...
VALUES (
  ...
  saveCntct( getCntctId(NEW.contact1_number),
             ...
             NEW.contact1_last,
             NEW.contact1_suffix,
             buildSimplePhoneJson(NEW.contact1_voice, NEW.contact1_alternate, NEW.contact1_fax),
             NEW.contact1_email,
             NEW.contact1_web,
  ...
  saveCntct( getCntctId(NEW.contact2_number),
             ...
             NEW.contact2_last,
             NEW.contact2_suffix,
             buildSimplePhoneJson(NEW.contact2_voice, NEW.contact2_alternate, NEW.contact2_fax),
             NEW.contact2_email,
             NEW.contact2_web,
