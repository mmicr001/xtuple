...
SELECT xt.add_column('taxtype', 'taxtype_id', 'SERIAL', 'PRIMARY KEY', 'public'),
       xt.add_column('taxtype', 'taxtype_name', 'TEXT', 'NOT NULL', 'public'),
       xt.add_column('taxtype', 'taxtype_descrip', 'TEXT', 'NULL', 'public'),
       xt.add_column('taxtype', 'taxtype_sys', 'BOOLEAN', 'NOT NULL DEFAULT FALSE', 'public'),
       xt.add_column('taxtype', 'taxtype_external_code', 'TEXT', 'NULL', 'public');

SELECT xt.add_constraint('taxtype', 'taxtype_taxtype_name_key', 'UNIQUE (taxtype_name)', 'public'),
       xt.add_constraint('taxtype', 'taxtype_taxtype_name_check', $$CHECK (trim(taxtype_name) != '')$$, 'public');
