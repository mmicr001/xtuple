...
SELECT
  ...
  xt.add_column('crmrole', 'crmrole_email',          'BOOLEAN', 'NOT NULL DEFAULT FALSE', 'public'),
...
COMMENT ON COLUMN public."crmrole".crmrole_email IS 'Can be used with target type EMAIL';
...
INSERT INTO crmrole (crmrole_name, crmrole_email, crmrole_phone, crmrole_sort, crmrole_system)
SELECT 'Home', true, true, 20, true
WHERE NOT EXISTS(SELECT 1 FROM crmrole WHERE crmrole_name='Home');

INSERT INTO crmrole (crmrole_name, crmrole_email, crmrole_phone, crmrole_sort, crmrole_system)
SELECT 'Office', true, true, 10, true
...
INSERT INTO crmrole (crmrole_name, crmrole_cntct, crmrole_addr, crmrole_email, crmrole_phone, crmrole_sort, crmrole_system)
SELECT 'Other', true, true, true, true, 99, true
