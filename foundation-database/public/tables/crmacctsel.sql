...
SELECT
  ...
  xt.add_column('crmacctsel', 'crmacctsel_mrg_vendinfo', 'boolean', 'DEFAULT false NOT NULL', 'public'),
...
ALTER TABLE public.crmacctsel DROP COLUMN IF EXISTS crmacctsel_mrg_vend;

ALTER TABLE public.crmacctsel ENABLE TRIGGER ALL;
