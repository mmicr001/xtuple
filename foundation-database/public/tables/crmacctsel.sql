...
SELECT
  ...
  xt.add_column('crmacctsel', 'crmacctsel_mrg_crmacct_cntct_id_1', 'boolean', 'DEFAULT false NOT NULL', 'public'),
  xt.add_column('crmacctsel', 'crmacctsel_mrg_crmacct_cntct_id_2', 'boolean', 'DEFAULT false NOT NULL', 'public'),
  xt.add_column('crmacctsel', 'crmacctsel_mrg_crmacct_competitor_id', 'boolean', 'DEFAULT false NOT NULL', 'public'),
  xt.add_column('crmacctsel', 'crmacctsel_mrg_crmacct_cust_id', 'boolean', 'DEFAULT false NOT NULL', 'public'),
  xt.add_column('crmacctsel', 'crmacctsel_mrg_crmacct_emp_id', 'boolean', 'DEFAULT false NOT NULL', 'public'),
  ...
  xt.add_column('crmacctsel', 'crmacctsel_mrg_crmacct_prospect_id', 'boolean', 'DEFAULT false NOT NULL', 'public'),
  xt.add_column('crmacctsel', 'crmacctsel_mrg_crmacct_salesrep_id', 'boolean', 'DEFAULT false NOT NULL', 'public'),
  xt.add_column('crmacctsel', 'crmacctsel_mrg_crmacct_taxauth_id', 'boolean', 'DEFAULT false NOT NULL', 'public'),
  ...
  xt.add_column('crmacctsel', 'crmacctsel_mrg_crmacct_vend_id', 'boolean', 'DEFAULT false NOT NULL', 'public'),
