...
SELECT xt.add_column('taxline', 'taxline_shipfromaddr_city', 'TEXT', 'NULL', 'public');
SELECT xt.add_column('taxline', 'taxline_shipfromaddr_region', 'TEXT', 'NULL', 'public');
SELECT xt.add_column('taxline', 'taxline_shipfromaddr_postalcode', 'TEXT', 'NULL', 'public');
SELECT xt.add_column('taxline', 'taxline_shipfromaddr_country', 'TEXT', 'NULL', 'public');
SELECT xt.add_column('taxline', 'taxline_taxtype_id', 'INTEGER', 'NULL', 'public');
SELECT xt.add_column('taxline', 'taxline_taxtype_external_code', 'TEXT', 'NULL', 'public');
SELECT xt.add_column('taxline', 'taxline_qty', 'NUMERIC', 'NULL', 'public');
SELECT xt.add_column('taxline', 'taxline_amount', 'NUMERIC', 'NULL', 'public');
SELECT xt.add_column('taxline', 'taxline_extended', 'NUMERIC', 'NULL', 'public');
...
SELECT xt.add_constraint('taxline', 'taxline_taxline_amount_check', $$CHECK ((taxline_line_type = 'L') = (taxline_amount IS NOT NULL))$$, 'public');
SELECT xt.add_constraint('taxline', 'taxline_taxline_extended_check', $$CHECK ((taxline_line_type = 'A') = (taxline_extended IS NULL))$$, 'public');
