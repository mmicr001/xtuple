CREATE OR REPLACE VIEW cust AS
  SELECT cust_id, cust_active, cust_custtype_id, cust_salesrep_id,
        ...
        getcontactphone(mc.cntct_id, 'Office')  AS cust_phone,
        getcontactphone(mc.cntct_id, 'Fax')    AS cust_fax,
        ...
        getcontactphone(cc.cntct_id, 'Office')  AS cust_corrphone,
        getcontactphone(mc.cntct_id, 'Fax')   AS cust_corrfax,
