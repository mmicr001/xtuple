...
BEGIN
  ...
  IF _service = 'A' THEN
    RETURN formatAvaTaxPayload(pOrderType, pOrderNumber, pFromLine1, pFromLine2, pFromLine3,
                               ...
                               pToLine3, pToCity, pToState, pToZip, pToCountry, pCust, pTaxReg,
                               pCurrId, pDocDate, pFreight, pMisc, _freighttaxtype, _misctaxtype,
                               pMiscDiscount, pFreightLine1, pFreightLine2, pFreightLine3,
                               pFreightCity, pFreightState, pFreightZip, pFreightCountry,
                               pFreightSplit, pLines, pQtys, _taxtypes, pAmounts, pLineLine1,
