...
DROP FUNCTION IF EXISTS _voitemBeforeTrigger() CASCADE;
DROP FUNCTION IF EXISTS _voitemAfterTrigger() CASCADE;
DROP FUNCTION IF EXISTS _vodistBeforeTrigger() CASCADE;
DROP FUNCTION IF EXISTS _vodistAfterTrigger() CASCADE;
DROP FUNCTION IF EXISTS _cobillBeforeTrigger() CASCADE;
DROP FUNCTION IF EXISTS _cobillTrigger() CASCADE;
DROP FUNCTION IF EXISTS _cobmiscBeforeTrigger() CASCADE;
