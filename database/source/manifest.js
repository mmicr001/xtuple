{
  ...
  "databaseScripts": [
    ...
    "share_users/functions/refresh_cache_share_users.sql",
    "share_users/functions/refresh_cache_share_users_obj.sql",
    "share_users/functions/refresh_cache_share_users_user.sql",
    "share_users/views/share_users_default.sql",
    "share_users/triggers/sharetype_did_change.sql",
    "share_users/triggers/refresh_obj_share_cache.sql",
    "share_users/triggers/refresh_cohead_share_users_cache.sql",
    "share_users/triggers/refresh_custinfo_share_users_cache.sql",
    "share_users/triggers/refresh_shiptoinfo_share_users_cache.sql",
    "share_users/triggers/refresh_addr_share_users_cache.sql",
    "share_users/triggers/refresh_cntct_share_users_cache.sql",
    "share_users/triggers/refresh_crmacct_share_users_cache.sql",
    "share_users/triggers/refresh_invchead_share_users_cache.sql",
    "share_users/tables/obj_share.sql",
    "share_users/tables/invchead.sql",
    "share_users/tables/addr.sql",
    "share_users/tables/cntct.sql",
    "share_users/tables/crmacct.sql",
    "share_users/tables/cohead.sql",
    "share_users/tables/custinfo.sql",
    "share_users/tables/shiptoinfo.sql",
    "share_users/views/share_users_invchead.sql",
    "share_users/views/share_users_cntct.sql",
    "share_users/views/share_users_addr.sql",
    "share_users/views/share_users_cohead.sql",
    "share_users/views/share_users_cust.sql",
    "share_users/views/share_users_cust_cntct.sql",
    "share_users/views/share_users_shipto.sql",
    "share_users/views/share_users_shipto_cntct.sql",
    "share_users/views/share_users_shipto_addr.sql",
    "share_users/views/share_users_shipto_cust.sql",
    "share_users/tables/sharetype.sql",
    "share_users/tables/cache_share_users.sql",
